---
name: joyride-workspace-automation.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/joyride-workspace-automation.instructions.md
license: MIT
domain: developer
---
