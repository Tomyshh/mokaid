---
name: power-platform-mcp-integration-expert.agent
...
source: https://github.com/github/awesome-copilot/blob/main/agents/power-platform-mcp-integration-expert.agent.md
license: MIT
domain: developer
---
