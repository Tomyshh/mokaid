---
name: workbenches-and-advanced
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/freecad-scripts/references/workbenches-and-advanced.md
license: MIT
domain: developer
---

# workbenches-and-advanced
