---
name: instrumentation-manual-python
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/phoenix-tracing/references/instrumentation-manual-python.md
license: MIT
domain: developer
---
