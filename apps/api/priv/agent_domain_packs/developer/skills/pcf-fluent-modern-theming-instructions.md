---
name: pcf-fluent-modern-theming.instructions
description: Style components with modern theming using Fluent UI
source: https://github.com/github/awesome-copilot/blob/main/instructions/pcf-fluent-modern-theming.instructions.md
license: MIT
domain: developer
---
