---
name: action-patterns-core
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/flowstudio-power-automate-build/references/action-patterns-core.md
license: MIT
domain: developer
---
