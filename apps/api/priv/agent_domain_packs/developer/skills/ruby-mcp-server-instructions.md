---
name: ruby-mcp-server.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/ruby-mcp-server.instructions.md
license: MIT
domain: developer
---

# ruby-mcp-server.instructions
