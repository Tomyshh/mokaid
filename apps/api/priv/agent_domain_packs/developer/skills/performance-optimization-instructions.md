---
name: performance-optimization.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/performance-optimization.instructions.md
license: MIT
domain: developer
---
