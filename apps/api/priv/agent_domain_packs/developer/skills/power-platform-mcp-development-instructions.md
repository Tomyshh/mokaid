---
name: power-platform-mcp-development.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/power-platform-mcp-development.instructions.md
license: MIT
domain: developer
---
