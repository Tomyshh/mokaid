---
name: convert-jpa-to-spring-data-cosmos.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/convert-jpa-to-spring-data-cosmos.instructions.md
license: MIT
domain: developer
---
