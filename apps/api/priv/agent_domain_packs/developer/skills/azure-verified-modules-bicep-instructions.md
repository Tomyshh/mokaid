---
name: azure-verified-modules-bicep.instructions
description: Azure Verified Modules (AVM) and Bicep
source: https://github.com/github/awesome-copilot/blob/main/instructions/azure-verified-modules-bicep.instructions.md
license: MIT
domain: developer
---
...
> Azure Verified Modules (AVM) and Bicep
