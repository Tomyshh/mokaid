---
name: rust-mcp-server.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/rust-mcp-server.instructions.md
license: MIT
domain: developer
---

# rust-mcp-server.instructions
