---
name: persistent-progression-and-events
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/minecraft-plugin-development/references/persistent-progression-and-events.md
license: MIT
domain: developer
---
