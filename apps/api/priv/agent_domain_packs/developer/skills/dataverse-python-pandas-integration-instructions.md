---
name: dataverse-python-pandas-integration.instructions
description: 
source: https://github.com/github/awesome-copilot/blob/main/instructions/dataverse-python-pandas-integration.instructions.md
license: MIT
domain: developer
---
