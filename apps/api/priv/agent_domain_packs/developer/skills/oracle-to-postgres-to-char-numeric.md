---
name: oracle-to-postgres-to-char-numeric
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/reviewing-oracle-to-postgres-migration/references/oracle-to-postgres-to-char-numeric.md
license: MIT
domain: developer
---
