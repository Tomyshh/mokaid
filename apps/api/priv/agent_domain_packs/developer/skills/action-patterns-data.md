---
name: action-patterns-data
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/flowstudio-power-automate-build/references/action-patterns-data.md
license: MIT
domain: developer
---
