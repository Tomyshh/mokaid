---
name: power-bi-dax-best-practices.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/power-bi-dax-best-practices.instructions.md
license: MIT
domain: developer
---
