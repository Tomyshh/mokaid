---
name: tailwind-v4-vite.instructions
description: Tailwind CSS v4+ installation and configuration for Vite projects using the official @tailwindcss/vite plugin
source: https://github.com/github/awesome-copilot/blob/main/instructions/tailwind-v4-vite.instructions.md
license: MIT
domain: developer
---

# tailwind-v4-vite.instructions
