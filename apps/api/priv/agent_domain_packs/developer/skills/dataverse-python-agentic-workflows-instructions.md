---
name: dataverse-python-agentic-workflows.instructions
description: 
source: https://github.com/github/awesome-copilot/blob/main/instructions/dataverse-python-agentic-workflows.instructions.md
license: MIT
domain: developer
---
