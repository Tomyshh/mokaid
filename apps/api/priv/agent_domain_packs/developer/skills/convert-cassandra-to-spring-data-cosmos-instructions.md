---
name: convert-cassandra-to-spring-data-cosmos.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/convert-cassandra-to-spring-data-cosmos.instructions.md
license: MIT
domain: developer
---
