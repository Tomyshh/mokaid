---
name: swift-mcp-server.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/swift-mcp-server.instructions.md
license: MIT
domain: developer
---

# swift-mcp-server.instructions
