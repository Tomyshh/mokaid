---
name: 2c-capture-and-verify-trace
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/eval-driven-dev/references/2c-capture-and-verify-trace.md
license: MIT
domain: developer
---
