---
name: pcf-dependent-libraries.instructions
description: Using dependent libraries in PCF components
source: https://github.com/github/awesome-copilot/blob/main/instructions/pcf-dependent-libraries.instructions.md
license: MIT
domain: developer
---
