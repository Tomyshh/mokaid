---
name: state-sessions-and-phases
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/minecraft-plugin-development/references/state-sessions-and-phases.md
license: MIT
domain: developer
---
