---
name: power-bi-custom-visuals-development.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/power-bi-custom-visuals-development.instructions.md
license: MIT
domain: developer
---
