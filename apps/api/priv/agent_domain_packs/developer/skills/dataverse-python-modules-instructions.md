---
name: dataverse-python-modules.instructions
description: 
source: https://github.com/github/awesome-copilot/blob/main/instructions/dataverse-python-modules.instructions.md
license: MIT
domain: developer
---
