---
name: azure-durable-functions-csharp.instructions
description: Guidelines and best practices for building Azure Durable Functions in C# using the isolated worker model
source: https://github.com/github/awesome-copilot/blob/main/instructions/azure-durable-functions-csharp.instructions.md
license: MIT
domain: developer
---
