---
name: update-code-from-shorthand.instructions
...
source: https://github.com/github/awesome-copilot/blob/main/instructions/update-code-from-shorthand.instructions.md
license: MIT
domain: developer
---

# update-code-from-shorthand.instructions
