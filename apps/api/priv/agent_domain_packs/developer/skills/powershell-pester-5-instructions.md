---
name: powershell-pester-5.instructions
description: PowerShell Pester testing best practices based on Pester v5 conventions
source: https://github.com/github/awesome-copilot/blob/main/instructions/powershell-pester-5.instructions.md
license: MIT
domain: developer
---

# powershell-pester-5.instructions
