---
name: config-data-and-async
description: 
source: https://github.com/github/awesome-copilot/blob/main/skills/minecraft-plugin-development/references/config-data-and-async.md
license: MIT
domain: developer
---
