---
name: taxcore-technical-writer.agent
description: A domain-expert technical writer for the TaxCore electronic fiscal invoicing ecosystem. Use this agent to create, improve, or review documentation for TaxCore applications — including the Secure Element Reader, smart card workflows, fiscal invoicing concepts, audit processes, and PKI/SE security topics. Covers end-user guides, developer docs, reference material, and setup guides across all TaxCore
source: https://github.com/github/awesome-copilot/blob/main/agents/taxcore-technical-writer.agent.md
license: MIT
domain: security
---

# taxcore-technical-writer.agent
